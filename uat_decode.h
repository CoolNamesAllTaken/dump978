...
{
    // presence bits
    unsigned int has_sv : 1;
    unsigned int has_ms : 1;
    unsigned int has_auxsv : 1;

    unsigned int position_valid : 1;
    unsigned int ns_vel_valid : 1;
    unsigned int ew_vel_valid : 1;
    unsigned int speed_valid : 1;
    unsigned int dimensions_valid : 1;
...
struct fisb_apdu
{
    ...
    int p_flag : 1;
    int s_flag : 1;
    unsigned int monthday_valid : 1;
    unsigned int seconds_valid : 1;
