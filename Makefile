...
all: dump978 uat2json uat2text uat2esnt uat2structs extract_nexrad
...
uat2structs: uat2structs.o uat_decode.o reader.o
	$(CC) -g -o $@ $^ $(LDFLAGS) $(LIBS)
...
clean:
	rm -f *~ *.o fec/*.o dump978 uat2json uat2text uat2esnt uat2structs fec_tests
